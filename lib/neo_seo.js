...
const fileToString = require('./io/file_to_string')
 ...
 * @api public
 */
function NeoSeo (customConfig, disabledList) {
 ...
 * @api public
 */
NeoSeo.prototype.getResult = function (input, output, callback) {
